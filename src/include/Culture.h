...
struct CulturalSummary {
  ...
  // how capable a society is to adapt to changing conditions. Environmental,
  // technological, cultural lower score the society is more resistant to
  // changing conditions and struggles with them higher score the society
  // handles changing conditions with understanding and patience
...
/// <summary>
/// a single trait of the society that is placed into a collection of traits,
/// the four scores will effect how a civilization makes decisions.
/// </summary>
struct CulturalTrait {
  ...
  // hierarchy_bias is how authoritarian the trait is. If it promotes a strict
  // vertical power structure then it has a high hierarchy_bias
  float hierarchy_bias; // continuous axes
  // how much a trait prefers group needs over individual needs.
  float collectivism;
  // how much a trait promotes risk taking either in expansion, innovation, or
  // strategy
